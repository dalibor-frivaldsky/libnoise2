...
#include "noise/module/SimplexBase.hpp"
...
namespace noise
{
	...
	namespace module
	{
		...
		class Simplex< ValueT, 1 >: public Module< ValueT, 1 >, public SimplexBase< ValueT >
		{
			public:
			...
			typedef Simplex< ValueType, Dimension >		ThisType;
		...
		template< typename ValueT >
		class Simplex< ValueT, 2 >: public Module< ValueT, 2 >, public SimplexBase< ValueT >
		{
			public:
		...
		template< typename ValueT >
		class Simplex< ValueT, 3 >: public Module< ValueT, 3 >, public SimplexBase< ValueT >
		{
			public:
		...
		template< typename ValueT >
		class Simplex< ValueT, 4 >: public Module< ValueT, 4 >, public SimplexBase< ValueT >
		{
			public:
