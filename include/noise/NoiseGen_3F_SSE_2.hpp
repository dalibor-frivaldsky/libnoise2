...
class NoiseGen< float, 3 >
{
	...
	GradientCoherentNoise( ValueType x, ValueType y, ValueType z, int seed = 0, NoiseQuality noiseQuality = QUALITY_STD )
	{
		...
		M::Vector4F		coordV = M::vectorize( x, y, z, ValueType( 0.0 ) );

		// Map the difference between the coordinates of the input value and the
		// coordinates of the cube's outer-lower-left vertex onto an S-curve.
		M::Vector4F		sCoordV;
		M::Vector4F		xyz_0 = M::vectorize( ValueType( x0 ), ValueType( y0 ), ValueType( z0 ), ValueType( 0.0 ) );
		...
		M::Vector4F		z_01 = M::vectorize( ValueType( z1 ), ValueType( z0 ), ValueType( 0.0 ), ValueType( 0.0 ) );
